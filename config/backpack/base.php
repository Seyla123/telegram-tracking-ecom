...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'web_routes_file' => base_path('routes/backpack/custom.php'),
    ...
    */
    ...
    'create_by_model_fqn' => config('auth.providers.users.model'),
    // 'create_by_model_fqn' => App\User::class, // works on Laravel <= 7
    // 'create_by_model_fqn' => App\Models\User::class, // works on Laravel >= 8
